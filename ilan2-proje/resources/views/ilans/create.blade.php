...
<div class="row justify-content-center">
    <div class="col-md-8">
        <div class="card">
            <div class="card-header">Yeni İlan Ekle</div>
            <div class="card-body">
                <form method="POST" action="{{ route('ilans.store') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('baslik') is-invalid @enderror" id="baslik" name="baslik" value="{{ old('baslik') }}" required>
                        @error('baslik')
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('aciklama') is-invalid @enderror" id="aciklama" name="aciklama" rows="5" required>{{ old('aciklama') }}</textarea>
                        @error('aciklama')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="d-flex justify-content-between">
                        <a href="{{ route('ilans.index') }}" class="btn btn-secondary">İptal</a>
